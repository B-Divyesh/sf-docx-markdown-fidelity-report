# Docx Markdown Fidelity Report (`docx-markdown-fidelity-report`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://docx-markdown-fidelity-report.sociobot.in`. Artifact class: `cli`.
